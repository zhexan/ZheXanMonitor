...
public class RequestLogFilter extends OncePerRequestFilter {
    ...
    private final Set<String> ignores = Set.of("/swagger-ui", "/v3/api-docs", "/monitor/runtime", "/monitor/list", "/alarm/unhandled", "/fault/pending", "/alarm/history");
    @Override
    ...
    public void logRequestStart(HttpServletRequest request){
        ...
        if(id != null) {
            ...
            if(authentication != null && authentication.getPrincipal() instanceof User user) {
                ...
                // 如果认证为空或不是User类型，记录基本请求信息
                log.info("请求URL: \"{}\" ({}) | 远程IP地址: {} │ 身份: 已认证但无用户详情 | UID: {} | 请求参数列表: {}",
                        request.getServletPath(), request.getMethod(), request.getRemoteAddr(), id, object);
            }
        } else {
